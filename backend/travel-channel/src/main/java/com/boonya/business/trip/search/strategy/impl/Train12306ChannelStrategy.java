...
@Slf4j
@Component
public class Train12306ChannelStrategy extends AbstractChannelStrategy {

    @Override
    protected Order doPlaceOrder(Order order) {
        log.info("[12306] 火车下单，订单号：{}", order.getOrderNo());

        // TODO: 调用 12306 API 下单

        log.info("[12306] 火车下单成功，订单号：{}", order.getOrderNo());
        return order;
    }
    ...
    public String getChannelName() {
        return TrainChannel.OFFICIAL_12306.getDesc();
    }
}
